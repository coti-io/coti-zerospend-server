...
[![GitHub Stars](https://img.shields.io/github/stars/coti-io/coti-zerospend-server.svg)](https://github.com/coti-io/coti-zerospend-server/stargazers)
[![GitHub Issues](https://img.shields.io/github/issues/coti-io/coti-zerospend-server.svg)](https://github.com/coti-io/coti-zerospend-server/issues)
[![Current Version](https://img.shields.io/badge/version-1.5.0.RELEASE-green.svg)](https://github.com/coti-io/coti-zerospend-server/)
...
java -jar zerospend/target/zerospend-1.5.0.RELEASE.jar --spring.config.additional-location=zerospend.properties
```
#### Docker container
